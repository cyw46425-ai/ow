(function (global) {
  ...
  const VERSION = "2.0.0";
  const DEFAULT_AS_OF = "2026-09-20";
  const CATEGORY_HINTS = {
    basics: ["新手", "入门", "第一次", "没玩过", "从哪里开始", "规则", "模式", "设置", "准星", "灵敏度", "怎么玩", "团灭", "集火", "掉点", "突然死", "追着人杀", "等队友"],
    heroes: ["英雄", "技能", "胜率", "选取率", "数据", "职责", "重装", "输出", "辅助", "坦克", "t位", "c位", "奶位"],
    strategy: ["克制", "反制", "怎么打", "阵容", "站位", "地图", "高台", "开盾", "能量", "换谁", "选什么"],
    lore: ["背景", "故事", "剧情", "关系", "组织", "世界观"],
    news: ["活动", "联动", "新闻", "返场", "线下", "奖励"],
    patch: ["版本", "补丁", "改动", "增强", "削弱", "更新", "热修", "热修改", "天赋", "子职责", "英雄禁用"],
    esports: ["比赛", "赛事", "赛程", "冠军", "战队", "直播", "owcs", "世界杯"]
  };
  ...
  function localAnswer(result) {
    ...
    return {
      conclusion: answer.conclusion || result.doc.summary,
      why: answer.why || "该结论来自本地知识库中匹配度最高的知识单元。",
      steps: answer.steps || [],
